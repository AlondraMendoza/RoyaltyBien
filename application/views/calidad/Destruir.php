    ...
    <div class="panel primary" data-role="panel">
        ...
        <tr>
            <td class="center" id="BotonesP"><br>
                ...
                <div class="input-control text big-input medium-size" id="botonguardar2P"><button class="button success" onclick="Procesar()">Destruir</button></div>
