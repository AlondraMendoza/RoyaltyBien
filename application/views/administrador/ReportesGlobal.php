<script>
    ...
    function DetalleSeleccionado(nombre)
    {
        ...
        $("#detalleseleccionado").load("GenerarDetalleSeleccionadoGlobal", {"fechainicio": fechainicio, "fechafin": fechafin, "clasificacion": clasificacionescadena, "producto": productoscadena, "modelo": modeloscadena, "color": colorescadena, 'por': por, 'nombre': nombre})
    }
    function Detalle()
    {
        ...
        $("#divtiporeporte").hide();
        $("#detalle").load("GenerarReporteGlobal", {"fechainicio": fechainicio, "fechafin": fechafin, "clasificacion": clasificacionescadena, "producto": productoscadena, "modelo": modeloscadena, "color": colorescadena})
    }
    function Concentrado()
    {
        ...
        $("#detalleseleccionado").hide();
        $("#divtiporeporte").hide();
        $("#detalle").load("GenerarConcentradoGlobal", {"fechainicio": fechainicio, "fechafin": fechafin, "clasificacion": clasificacionescadena, "producto": productoscadena, "modelo": modeloscadena, "color": colorescadena, "por": por});
    }
    function Paso(paso)
    {
        $("#paso1").hide();
