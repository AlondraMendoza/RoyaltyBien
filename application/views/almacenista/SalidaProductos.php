...
<h1><b> SALIDA DE PRODUCTOS</b></h1><br>
<center>
    <div class="panel warning" data-role="panel">
        <div class="heading">
            <span class="icon mif-stack fg-white bg-darkOrange"></span>
    ...
    <div class="panel primary" data-role="panel">
        ...
        <tr>
            <td class="center" id="BotonesP"><br>
                <div class="input-control text big-input medium-size" id="nuevatarima2P" style="display: none"><button class="button warning" onclick="CancelarP()">Nueva Salida</button></div>
                <div class="input-control text big-input medium-size" id="botonguardar2P"><button class="button success" onclick="SalidaTarimasP()">Guardar</button></div>
...
var guardadoP = 0;
    function SalidaTarimasP() {
        if (guardadoP == 0) {
            $("input[name='IDS2P[]']:checked").each(function () {
                var id = $(this).val();
                $.post("SalirTarimasAlmacenP", {"idtarima": id}, function (data) {
                    if (data == "Correcto")
                    {
