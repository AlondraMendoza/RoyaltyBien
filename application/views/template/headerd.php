...
<body>
    <div class="app-bar" data-role="appbar"
        style="position: fixed;z-index: 999999;background-color: #5a0303;padding-right: 20px;">
        <a class="app-bar-element" href="<?= base_url() ?>inicio/index"><img src="<?= base_url() ?>public/img/logo.png"
        ...
        <div class="app-bar-element place-right">
            <a class="dropdown-toggle fg-white"> <img
                    onerror="this.src='<?= base_url() ?>public/imagenes/fotos/user.png'"
                    src="<?= base_url(); ?>public/imagenes/fotos/<?= IdPersona(); ?>.jpg?v=<?= Date(DATE_RFC822, time()); ?>"
            ...
            <div class="app-bar-drop-container bg-white fg-dark place-right" data-role="dropdown" data-no-close="true"
                ...
                <div class="padding10" style="width: 200px;">
                    <center>
                        <img onerror="this.src='<?= base_url() ?>public/imagenes/fotos/user.png'"
                            src="<?= base_url() ?>public/imagenes/fotos/<?= IdUsuario() ?>.jpg?v=<?= Date(DATE_RFC822, time()); ?>"
                            height="150px;" width="150px;" title="<?= NombreUsuario() ?>">
                        <br>
                    ...
                    <center>
                        <button class="text-shadow block-shadow-success button success"
                            onclick="window.location = '<?php echo base_url() ?>usuario/cerrar_sesion'">Salir</button>
                    </center>
                </div>
            </div>
        </div>
    ...
    <div
        style="z-index: 9999;width: 40px;height: 40px;position: fixed;right:0px;top:50px;background-color: #5a0303;color:white;text-align: center">
        <a id="menu" href="<?php echo base_url() ?>usuario/logueado"><i class="mif-home mif-2x fg-white"></i></a></div>
