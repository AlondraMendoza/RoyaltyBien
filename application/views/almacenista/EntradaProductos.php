    ...
    <div class="panel primary" data-role="panel">
        ...
        <tr>
            <td class="center" id="BotonesP"><br>
                ...
                <div class="input-control text big-input medium-size" id="botonguardar2P"><button class="button success" onclick="GuardarTarimasP()">Guardar</button></div>
...
var guardadoP = 0;
    function GuardarTarimasP() {
        if (guardadoP == 0) {
            $("input[name='IDS2P[]']:checked").each(function () {
                var id = $(this).val();
                $.post("GuardarTarimasAlmacenP", {"idProducto": id}, function (data) {
                    if (data == "Correcto")
                    {
